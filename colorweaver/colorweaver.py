...
class colorweaver:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Colorweaver')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('colorweaver', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/colorweaver/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Colorweaver'),
            callback=self.run,
